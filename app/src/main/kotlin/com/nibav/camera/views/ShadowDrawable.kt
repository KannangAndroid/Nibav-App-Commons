package com.nibav.camera.views
...
class ShadowDrawable(context: Context, private val drawable: Drawable, @StyleRes styleResId: Int) : Drawable() {
    ...
    init {
        ...
        if (styleResId != 0) {
            ...
            shadowColor =
                obtainStyledAttributes.getColor(R.styleable.ShadowDrawable_android_shadowColor, ContextCompat.getColor(context, com.nibav.commons.R.color.md_grey_400_dark))
