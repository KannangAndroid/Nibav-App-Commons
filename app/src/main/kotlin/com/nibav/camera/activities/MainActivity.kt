...
import com.nibav.camera.BuildConfig
import com.nibav.camera.R
import com.nibav.camera.databinding.ActivityMainBinding
import com.nibav.camera.extensions.config
import com.nibav.camera.extensions.fadeIn
import com.nibav.camera.extensions.fadeOut
import com.nibav.camera.extensions.setShadowIcon
import com.nibav.camera.extensions.toFlashModeId
import com.nibav.camera.helpers.*
import com.nibav.camera.implementations.CameraXInitializer
import com.nibav.camera.implementations.CameraXPreviewListener
import com.nibav.camera.interfaces.MyPreview
import com.nibav.camera.models.ResolutionOption
import com.nibav.camera.models.TimerMode
import com.nibav.camera.views.FocusCircleView
...
class MainActivity : SimpleActivity(), PhotoProcessor.MediaSavedListener, CameraXPreviewListener {
        ...
        override fun onTabSelected(tab: TabLayout.Tab) {
            handlePermission(PERMISSION_RECORD_AUDIO) {
                if (it) {
                    ...
                    toast(com.nibav.commons.R.string.no_audio_permissions)
                    selectPhotoTab()
    ...
    /* private fun tryInitCamera() {
         handlePermission(PERMISSION_CAMERA) { grantedCameraPermission ->
             if (grantedCameraPermission) {
                 ...
                 toast(com.nibav.commons.R.string.no_camera_permissions)
                 finish()
             }
         }
     }*/
    ...
    private fun initializeCamera(isInPhotoMode: Boolean) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(binding.viewHolder) { _, windowInsets ->
            ...
            val marginBottom = safeInsetBottom + navigationBarHeight + resources.getDimensionPixelSize(com.nibav.commons.R.dimen.bigger_margin)
    ...
    private fun setButtonColors(button: MaterialButton) {
        ...
        val iconColors = intArrayOf(ContextCompat.getColor(this, com.nibav.commons.R.color.md_grey_white), primaryColor)
