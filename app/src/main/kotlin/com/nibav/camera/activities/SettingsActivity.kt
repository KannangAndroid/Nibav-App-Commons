...
import com.nibav.camera.databinding.ActivitySettingsBinding
import com.nibav.camera.extensions.checkLocationPermission
...
class SettingsActivity : SimpleActivity() {
    ...
    private fun refreshMenuItems() {
        binding.settingsToolbar.menu.apply {
            findItem(R.id.more_apps_from_us).isVisible = !resources.getBoolean(com.nibav.commons.R.bool.hide_google_relations)
        }
    }
                ...
                if (checkLocationPermission()) {
                    ...
                    handlePermission(PERMISSION_ACCESS_FINE_LOCATION) { _ ->
                        if (checkLocationPermission()) {
                            ...
                            OpenDeviceSettingsDialog(activity = this@SettingsActivity, message = getString(com.nibav.commons.R.string.allow_location_permission))
                        }
                    }
                }
            } else {
